...
| **Models** | 1 architecture, 4 stages | 9 architectures, mostly instruct |
| **Conditions** | 12 | 4 (subset) |
| **Temperatures** | 6 | 2 |
...
**Data:** `runs/` (17 runs, 9 model families) + `runs/think/` (1 run)
...
| 7 | olmo-3.1-32b-think | 32B | +0.035 | +0.017 | 12% | 15% |
| 8 | gpt-oss-20b | 20B | — | +0.013 | 18% | 3% |
| 9 | grok-4.1-fast | — | -0.003 | -0.007 | 8% | 6% |
...
1. **Per-model McNemar tests** (control vs each pressure condition) with Holm correction
...
1. Discovers all runs in `runs/` (excluding incomplete gpt-oss-20b T=0.0)
