...
#SBATCH --job-name=AAM_OLMO_POSTHOC_T0P8
...
python experiments/olmo_conformity/configs/run_interpretability_posthoc.py --run-id eb777acc-3ab5-4f87-b073-249a50d25863 --hpc
