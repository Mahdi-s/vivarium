...
#SBATCH --job-name=AAM_32B_RL

# ---------------------------------------------------------------------------
# OLMo-3 32B Think-RL (RLVR / Rethink) — Run Trials
#
# Usage:
#   TEMPERATURE=0.0 sbatch job_32b_think_rl.sh
#   TEMPERATURE=0.6 sbatch job_32b_think_rl.sh
#
...
if [ "${TEMPERATURE}" = "0.6" ]; then
    SUITE="suite_32b_think_rl_temp0p6.json"
else
    SUITE="suite_32b_think_rl_temp0p0.json"
fi
...
echo "=== OLMo 32B Think-RL (Rethink) Run: suite=${SUITE}, temperature=${TEMPERATURE} ==="
