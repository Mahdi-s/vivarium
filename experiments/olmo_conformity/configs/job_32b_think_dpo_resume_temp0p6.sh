...
#SBATCH --job-name=AAM_32B_DPO_RSM_T06

# ---------------------------------------------------------------------------
# Resume OLMo-3 32B Think-DPO @ temperature 0.6 for a fixed run_id.
#
...
RUN_ID="d0158f56-c99c-4e7d-92fc-c7ece3190781"
...
echo "=== Resume OLMo 32B Think-DPO T=0.6 | suite=${SUITE} | run-id=${RUN_ID} | runs-dir=${RUNS_DIR} ==="
...
echo "=== Resume OLMo 32B Think-DPO T=0.6 (run-id=${RUN_ID}) complete ==="
