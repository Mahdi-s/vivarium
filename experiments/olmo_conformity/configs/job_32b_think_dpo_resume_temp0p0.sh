...
#SBATCH --job-name=AAM_32B_DPO_RSM_T0

# ---------------------------------------------------------------------------
# Resume OLMo-3 32B Think-DPO @ temperature 0.0 for a fixed run_id.
#
...
RUN_ID="3041fb7e-98bc-4343-90d7-e56d9e134a3b"
...
echo "=== Resume OLMo 32B Think-DPO T=0.0 | suite=${SUITE} | run-id=${RUN_ID} | runs-dir=${RUNS_DIR} ==="
...
echo "=== Resume OLMo 32B Think-DPO T=0.0 (run-id=${RUN_ID}) complete ==="
