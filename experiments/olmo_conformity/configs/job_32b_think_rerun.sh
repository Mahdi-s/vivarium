...
#SBATCH --job-name=AAM_32B_THINK_RERUN

# ---------------------------------------------------------------------------
# OLMo-3 32B Think Variants — RERUN with Extended Tokens (4096)
#
# Fixes truncation: original 512-token limit truncated 99%+ of outputs.
#
# Usage:
#   TEMPERATURE=0.0 sbatch job_32b_think_rerun.sh
#   TEMPERATURE=0.6 sbatch job_32b_think_rerun.sh
#
...
echo "=== OLMo 32B Think RERUN: suite=${SUITE}, temperature=${TEMPERATURE}, max_new_tokens=4096 ==="
