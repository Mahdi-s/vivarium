...
#SBATCH --job-name=AAM_32B_SFT_RSM_T06

# ---------------------------------------------------------------------------
# Resume OLMo-3 32B Think-SFT @ temperature 0.6 for a fixed run_id.
#
...
RUN_ID="e673de86-d8dc-4ce0-bfc9-969d531eb425"
...
echo "=== Resume OLMo 32B Think-SFT T=0.6 | suite=${SUITE} | run-id=${RUN_ID} | runs-dir=${RUNS_DIR} ==="
...
echo "=== Resume OLMo 32B Think-SFT T=0.6 (run-id=${RUN_ID}) complete ==="
