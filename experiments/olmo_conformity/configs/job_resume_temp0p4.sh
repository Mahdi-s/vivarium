...
#SBATCH --job-name=AAM_RESUME_T0P4

set -euo pipefail

# RESUME run for T=0.4 (run_v2: runs-hpc-full/run_v2/runs)
# run_id: 0d0eb2bd-7575-4945-85fa-a9ddc38f8c3a
...
python -m aam olmo-conformity \
    --suite-config experiments/olmo_conformity/configs/suite_resume_temp0.4.json \
    --runs-dir runs-hpc-full/run_v2/runs \
    --run-id 0d0eb2bd-7575-4945-85fa-a9ddc38f8c3a
