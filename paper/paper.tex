...
\begin{enumerate}
    \item \textbf{No mechanistic traces in this temperature sweep}: The present results focus on behavioral outcomes (accuracy, pressure deltas, truth override, and opinion agreement). Although the broader codebase supports activation capture, probe training, and causal interventions, these mechanistic artifacts were not available for the runs analyzed here; mechanistic interpretability is therefore deferred to future work.
